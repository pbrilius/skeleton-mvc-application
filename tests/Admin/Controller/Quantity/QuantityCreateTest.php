...
use Admin\Controller\Quantity\QuantityCreate;
 ...
 * @link     pbgroupeu.wordpress.com
 */
class QuantityCreateTest extends BaseCrudUnit
{
    /**
     * QE case
     *
    ...
    {
        $qe = $this
            ->getMockBuilder(QuantityCreate::class)
        ...
        $this->assertClassNotHasAttribute('_cmsModel', QuantityCreate::class);
        $this->assertClassNotHasAttribute('_templateEngine', QuantityCreate::class);
    }
}
