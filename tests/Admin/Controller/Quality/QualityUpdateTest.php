...
use Admin\Controller\Quality\QualityUpdate;
 ...
 * @link     pbgroupeu.wordpress.com
 */
class QualityUpdateTest extends BaseCrudUnit
{
    /**
     * QE case
     *
    ...
    public function testQe(): void
    {
        ...
        $this->assertClassNotHasAttribute('_cmsModel', QualityUpdate::class);
        $this->assertClassNotHasAttribute('_templateEngine', QualityUpdate::class);
    }
}
