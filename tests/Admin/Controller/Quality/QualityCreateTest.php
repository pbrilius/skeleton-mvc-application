 ...
 * @link     pbgroupeu.wordpress.com
 */
class QualityCreateTest extends BaseCrudUnit
{
    /**
     * QE case
     *
    ...
    {
        $qe = $this
            ->getMockBuilder(QualityCreate::class)
        ...
        $this->assertClassNotHasAttribute('_cmsModel', QualityCreate::class);
        $this->assertClassNotHasAttribute('_templateEngine', QualityCreate::class);
    }
}
